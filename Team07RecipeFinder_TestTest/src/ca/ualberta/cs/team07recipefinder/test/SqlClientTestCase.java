...
public class SqlClientTestCase extends AndroidTestCase {
	...
	*/
	...
	public void testUpdateRecipe() {
		...
		assertTrue(tempRecipe.getIngredients().get(1).equals(
		...
		assertTrue(tempRecipe.getDirections().equals(
